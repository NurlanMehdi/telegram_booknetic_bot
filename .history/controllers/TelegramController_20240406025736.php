...
class TelegramController
{
    ...
    private function processMessage($chatId, $username, $messageText)
    {
        ...
        if ($messageText == '/start') {
            ...
            // Belirli sınıfa sahip öğeleri seçin
            $elements = $html->find('.booknetic_service_title_span');
            
            // Öğeler üzerinde işlem yapın
            foreach ($elements as $element) {
                echo $element->plaintext . "\n"; // Öğe içeriğini yazdırın
            }
            
            // Ayrıştırıcıyı temizleyin
            $html->clear();
