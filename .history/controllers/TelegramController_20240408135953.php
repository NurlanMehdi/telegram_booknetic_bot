            ...
            if($dateTime)
            {
                ...
                if(!empty($data['data']['dates'][$dateTime->format('Y-m-d')])){
                   ...
                   // var_dump($data['data']['dates']);
                    ...
                    // Ana dizi üzerinde tarihleri işleyen döngü
                    foreach ($dates as $date => $events) {
                        ...
                        foreach ($events as $event) {
                            ...
                            // İlgili tarih ve saat aralığını $aviableDatesMessage değişkenine ekle
                            $aviableDatesMessage .= "<b>$date</b>: {$start_time_format} - {$end_time_format}\n";
                        }
                    }
