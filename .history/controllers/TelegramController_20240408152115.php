...
class TelegramController
{
    ...
    private function processMessage($chatId, $username, $messageText)
    {
        ...
        if ($messageText == "/start") {
            ...
            $service = $this->messagesModel->getLastMessageServiceData($chatId);

           // var_dump($service);
            $servicesInfo = "1: <b>{$service['title']}</b> - {$service['price']} \n
                             2: <b>Tarix</b> - {$service['price']} \n 
                             3: <b>Saat</b> - {$service['price']} \n 
                             4: <b>Ad</b> - {$userInfo[0]} \n  
                             5: <b>Soyad</b> - {$userInfo[0]} \n  
                             6: <b>Email</b> - {$userInfo[0]} \n  
                             7: <b>Mobil nömrə</b> - {$userInfo[0]} \n  ";
