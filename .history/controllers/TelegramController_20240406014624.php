...
include_once __DIR__ . '..$bookneticController = new BookNeticController();
$data = $bookneticController->getDataService();/BookneticController.php';
